...
public class ColourNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    @ResponseStatus
    @ExceptionHandler(ColourNotFoundException.class)
    public ResponseEntity<ValidateErrorMessage> colourNotFountExceptionHandler(ColourNotFoundException cnfe, WebRequest request){
