...
public class ContactNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    @ResponseStatus
    @ExceptionHandler(ContactNotFoundException.class)
    public ResponseEntity<ValidateErrorMessage> contactExceptionValidator(ContactNotFoundException cnfe, WebRequest request){
