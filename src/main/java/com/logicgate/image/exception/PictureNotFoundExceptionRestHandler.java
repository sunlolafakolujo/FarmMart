...
public class PictureNotFoundExceptionRestHandler extends ResponseEntityExceptionHandler {
    @ResponseStatus
    @ExceptionHandler(PictureNotFoundException.class)
    public ResponseEntity<ValidateErrorMessage> pictureNotFoundExceptionHandler(PictureNotFoundException pnfe,
                                                                                WebRequest request){
